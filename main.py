...
#Start debate
@client.command()
async def CP(context,minutes):
    #Invalid Time Corner Case
    if int(minutes) < 3 or int(minutes) > 10:
        await context.send("Invalid Time. Must be atleast 3 to 10 minutes.")
        raise Exception("Invalid Time")
...
#Start debate
@client.command()
async def CPLO(context,minutes):
    #Invalid Time Corner Case
    if int(minutes) < 3 or int(minutes) > 10:
        await context.send("Invalid Time. Must be atleast 3 to 10 minutes.")
        raise Exception("Invalid Time")
